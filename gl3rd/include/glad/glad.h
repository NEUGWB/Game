/*
    ...
    OpenGL loader generated by glad 0.1.34 on Thu Jan 28 03:38:50 2021.
...
#if defined(_WIN32) && !defined(APIENTRY) && !defined(__CYGWIN__) && !defined(__SCITECH_SNAP__) && !defined(APIENTRY)
